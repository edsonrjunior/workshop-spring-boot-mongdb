package br.com.edson.workshopmongodb.config;
...
import br.com.edson.workshopmongodb.dto.AuthorDTO;
import br.com.edson.workshopmongodb.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2018"), "Parti viagem", "Vou viajara para São Paulo. Abraços.",
				new AuthorDTO(maria));
